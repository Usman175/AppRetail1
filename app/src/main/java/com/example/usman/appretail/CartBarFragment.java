...
public class CartBarFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        cartbtn=(Button)v.findViewById(R.id.btnOrder);
        tvTotal=(TextView)v.findViewById(R.id.tvTCost);
        return v;
    }
    ...
    /*public void changeCartDetails(String data){
        this.data = data;
        tv.setText(data);
    ...
    public void onClick(View view) {
        ...
        // ya phir apne logic bana gy kuch b
